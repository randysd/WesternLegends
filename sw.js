const CACHE_NAME = 'wl-frontier-director-v36';
const APP_SHELL = [
  ...
  './assets/images/triggers/move.svg', './assets/images/triggers/poker.svg', './assets/images/triggers/ranch.svg', './assets/images/triggers/generic.svg',
  './data/settings.json', './data/triggers.json', './data/one-off-events.json', './data/character-arcs.json',
