const CACHE_NAME = 'wl-western-legends-companion-v139';
const APP_SHELL = [
  './', './index.html', './version.json', './manifest.webmanifest', './css/styles.css?v=139', './css/home-frontier.css?v=137', './js/localized-data.js', './js/character-picker-core.js?v=137', './js/contextual-music-core.js?v=137', './js/update-core.js?v=139', './js/app.js?v=139', './js/home-frontier.js?v=137', './assets/icons/icon.svg', './assets/icons/icon-cabin.png', './assets/icons/icon-hat.png', './assets/icons/icon-book.png', './assets/icons/icon-lantern.png', './assets/icons/icon-gazette.png', './assets/icons/icon-fight.png',
